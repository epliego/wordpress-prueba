...
<div class="post-detail-row">
	...
	<div class="row">
		<div class="small-12 medium-10 medium-centered columns">
			  <article itemscope itemtype="http://schema.org/Article" <?php post_class('post blog-post style4'); ?> id="post-<?php the_ID(); ?>" role="article" data-id="<?php the_ID(); ?>" data-url="<?php the_permalink(); ?>">
